...
extern "C" int build_partial_coloring_from_adolc(void** ref, int* len, unsigned int** csr, int rowcount, int colcount, const char* _method, const char* _order, int verbose);
